...
<title>Manage Brand</title>
    ...
    <script src="js/bootstrap.min.js"></script>
        <div class="container-fluid" style="text-align:center">
            ...
            <table class="table">
                <tr><td>ลำดับ</td><td>รหัสการสั่งซื้อสินค้า</td><td>สถานะ</td><td>เครื่องมือ</td></tr>
                <?php
                $result = view("select a.order_id,b.order_id as ordid from orders a LEFT JOIN receive b on a.order_id = b.order_id order by a.order_id asc");
				$i =1;
                foreach ($result as $data ) {
                    ...
                    if($data['ordid'] == NULL)
                        ...
                        echo "<td>รับสินค้าเรียบร้อยแล้ว</td></tr>";
                    $i++;
                }
