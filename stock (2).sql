...
--
-- Host: localhost
-- Generation Time: May 30, 2016 at 10:19 AM
...
INSERT INTO `product` (`prod_id`, `supplier_id`, `brand_id`, `model_id`, `category_id`, `amount`, `warranty`, `warrantytype`) VALUES
(00000005, 00000002, 00000003, 00000002, 00000003, 0, 3, 3),
(00000006, 00000002, 00000001, 00000002, 00000003, 0, 3, 3),
(00000007, 00000001, 00000003, 00000002, 00000003, 0, 3, 3),
(00000008, 00000002, 00000001, 00000003, 00000003, 0, 3, 3),
(00000009, 00000002, 00000001, 00000001, 00000003, 0, 3, 3);
...
--
ALTER TABLE `category`
  MODIFY `category_id` int(8) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
...
--
ALTER TABLE `model`
  MODIFY `model_id` int(8) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
...
--
ALTER TABLE `product`
  MODIFY `prod_id` int(8) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
--
